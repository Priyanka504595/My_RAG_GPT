# ✅ Ollama RAG Chatbot Integration with Streamlit and LangChain

# 1. Install Ollama from https://ollama.com/download
# 2. Pull the Mistral model (small and fast):
#    ollama pull mistral
# 3. Then run this chatbot with: streamlit run chatbot_ollama.py
...
# Path to your FAISS DB (already created from your .pdf/.txt/.md)
...
def load_llm():
    # return OllamaLLM(model="mistral", temperature=0.2) #with mistral
    return OllamaLLM(model="gemma:2b", temperature=0.2) #with light n faster gemma:2b
